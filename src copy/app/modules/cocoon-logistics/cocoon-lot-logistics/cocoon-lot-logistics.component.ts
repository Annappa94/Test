...
@Component({
  selector: 'app-cocoon-lot-logistics',
  templateUrl: './cocoon-lot-logistics.component.html',
  styleUrls: ['./cocoon-lot-logistics.component.scss']
})
export class CocoonLotLogisticsComponent implements OnInit {
  searchText = '';
  id = '';
  status = '';
  isTableLoaded = false;
