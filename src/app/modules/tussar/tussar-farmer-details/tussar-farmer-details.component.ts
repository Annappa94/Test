...
@Component({
  selector: 'app-tussar-farmer-details',
  templateUrl: './tussar-farmer-details.component.html',
  styleUrls: ['./tussar-farmer-details.component.scss']
})
export class TussarFarmerDetailsComponent implements OnInit {
  searchText = '';
  isTableLoaded = false;
  farmerDetails;
  centerName;
  ...
  editFarmer() {
    if (this.farmerDetails?.productType == 'Cotton') {
      ...
      this.router.navigate(['/resha-farms/tussar/tussar-farmer-crud', this.farmerDetails.id]);
    }
  }
