...
@Component({
  selector: 'app-cocoon-farmer-details',
  templateUrl: './cocoon-farmer-details.component.html',
  styleUrls: ['./cocoon-farmer-details.component.scss']
})
export class CocoonFarmerDetailsComponent implements OnInit {
  ...
  navigateToKyc(){
    if(this.farmerDetails.customerTypeName){
     ...
     this.router.navigate(['/resha-farms/farmers-kyc',this.id,'farmer',this.farmerDetails.customerTypeName]);
    } else {
  ...
  editFarmer() {
    if(this.farmerDetails?.productType == 'Cotton'){
      ...
      this.router.navigate(['/resha-farms/farmers-silk/crud', this.farmerDetails.id]);
    }
  }
  ...
  chawkiDetails(item) {
    this.router.navigate(['/resha-farms/chawki/details', item.chawkiId]);
  }
  ...
  goToDeviceDetails(deviceId) {
    this.router.navigate(['/resha-farms/rearing-iot/details',{id: deviceId, farmerId: this.farmerDetails.code}]);
  }
